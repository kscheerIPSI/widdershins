...
function getParameters(data) {
    ...
    for (let param of data.parameters) {
        ...
        if (pSchema) {
            if (pSchema.maxLength) {
                param.maxLength = pSchema.maxLength;
            }
            ...
            for (let block of props) {
                for (let prop of block.rows) {
                    ...
                    if (param.schema.maxLength) {
                        param.maxLength = param.schema.maxLength;
                    }
                    param.required = prop.required || prop.schema.required;
